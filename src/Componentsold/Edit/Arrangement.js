...
export default function Arrangement({ element }) {
  ...
  let layouts = container.hasOwnProperty("layoutJSON")
    ? JSON.parse(container.layoutJSON)
    : {
        lg: layout,
        md: layout,
        sm: layout
        ...
        <React.Fragment>
          <ResponsiveGridLayout
            ...
            onLayoutChangeoff={(layout, layouts) =>
              action("SAVE_LAYOUT", { element: container, layout: layouts })
            }
          ...
          <Typography align={"center"}>
            <div
              onClick={() =>
                action("ADD_BLANK_TO_LAYOUT", { parent: container.id })
              }
            >
